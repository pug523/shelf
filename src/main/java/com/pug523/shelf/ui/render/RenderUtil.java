...
import com.pug523.shelf.ui.render.state.SdfRenderState;
import com.pug523.shelf.ui.render.state.ShelfGuiElementRenderState;
import com.pug523.shelf.ui.render.state.VanillaRectangleRenderState;
...
public class RenderUtil {
    ...
    public static void renderSdfGuiElement(GuiCompat gui, SdfRenderState renderState) {
        ...
        //#else
        //$$ RenderSystem.setShader(ShaderManager::compiledSdfShader);
        //$$ renderGuiElement(gui, renderState, RenderTypes.SDF_RENDER_TYPE);
        //#endif
    }
