...
public class DropdownOverlay implements OverlayWidget {
    ...
    private final List<? extends ClickableWidget> items;
    private final Runnable onDismiss;
    private final Consumer<ClickableWidget> onSelect;
    ...
    public DropdownOverlay(
        ...
        int width,
        int height,
        List<? extends ClickableWidget> items,
        Runnable onDismiss,
        Consumer<ClickableWidget> onSelect
    ) {
        this.x = x;
        this.y = y;
        this.width = width;
    ...
    public void render(Font font, GuiCompat gui, LayoutEngine layout, int x, int y, int width, int height, int mouseX, int mouseY) {
        int currentY = this.y;
        for (ClickableWidget item : items) {
